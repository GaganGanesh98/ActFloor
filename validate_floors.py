...
Usage:  .venv/bin/python validate_floors.py
"""
import os
import pathlib
import sys
...
CFG = Cfg(
    ...
    ratios=(0.75, 0.5), b_calib=(0, 4), topk=64,
    methods=("act_aware_greedy",),          # no plain SVD -> no new cache writes
    floor=0.25, floors=(0.1, 0.25, 0.4),
...
res = {}
run_model(CFG, res, os.path.join(CFG.scratch, CFG.out_name), do_1b=True)
print_table(res)
